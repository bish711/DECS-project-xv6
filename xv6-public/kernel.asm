...
80100028:	bc f0 82 12 80       	mov    $0x801282f0,%esp
...
801003b0:	e8 eb 02 00 00       	call   801006a0 <cprintf>
  cprintf("\n");
801003b5:	c7 04 24 7b 7e 10 80 	movl   $0x80107e7b,(%esp)
...
801024d2:	81 fb f0 82 12 80    	cmp    $0x801282f0,%ebx
...
80103077:	68 f0 82 12 80       	push   $0x801282f0
...
80103824:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103827:	c7 40 14 92 58 10 80 	movl   $0x80105892,0x14(%eax)
  p->context = (struct context*)sp;
...
801041fb:	68 7b 7e 10 80       	push   $0x80107e7b
...
80104228:	8b 14 85 6c 7b 10 80 	mov    -0x7fef8494(,%eax,4),%edx
      state = "???";
...
801042aa:	68 84 7b 10 80       	push   $0x80107b84
...
801044e5:	68 8f 7b 10 80       	push   $0x80107b8f
801044ea:	e8 91 be ff ff       	call   80100380 <panic>
    panic("popcli");
801044ef:	83 ec 0c             	sub    $0xc,%esp
801044f2:	68 a6 7b 10 80       	push   $0x80107ba6
...
8010455b:	68 ad 7b 10 80       	push   $0x80107bad
...
80104650:	68 b5 7b 10 80       	push   $0x80107bb5
...
80104a60 <syscall>:
[SYS_tempfscreate] sys_tempfscreate,
};
...
80104a7c:	8b 14 85 e0 7b 10 80 	mov    -0x7fef8420(,%eax,4),%edx
...
80104aa8:	68 bd 7b 10 80       	push   $0x80107bbd
...
80104c04:	68 58 7c 10 80       	push   $0x80107c58
...
80104c1c:	68 57 7c 10 80       	push   $0x80107c57
...
80104c31:	68 4b 7c 10 80       	push   $0x80107c4b
...
80104c4f:	68 5a 7c 10 80       	push   $0x80107c5a
80104c54:	e8 27 b7 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104c59:	83 ec 0c             	sub    $0xc,%esp
80104c5c:	68 3c 7c 10 80       	push   $0x80107c3c
...
8010505d:	58                   	pop    %eax
8010505e:	5a                   	pop    %edx
8010505f:	68 58 7c 10 80       	push   $0x80107c58
...
80105078:	68 57 7c 10 80       	push   $0x80107c57
...
80105690 <sys_tempfscreate>:

int
sys_tempfscreate(void)
{
...
8010569c:	e8 3f f3 ff ff       	call   801049e0 <argstr>
801056a1:	83 c4 10             	add    $0x10,%esp
801056a4:	85 c0                	test   %eax,%eax
801056a6:	78 18                	js     801056c0 <sys_tempfscreate+0x30>
{
return -1;
}
return tempfscreate(filename);
801056a8:	83 ec 0c             	sub    $0xc,%esp
801056ab:	ff 75 f4             	push   -0xc(%ebp)
801056ae:	e8 8d 1b 00 00       	call   80107240 <tempfscreate>
...
{
  return fork();
801056d0:	e9 3b e4 ff ff       	jmp    80103b10 <fork>
...
801056e3:	83 ec 08             	sub    $0x8,%esp
  exit();
801056e6:	e8 a5 e6 ff ff       	call   80103d90 <exit>
...
{
  return wait();
801056f0:	e9 cb e7 ff ff       	jmp    80103ec0 <wait>
...
8010570c:	e8 0f f2 ff ff       	call   80104920 <argint>
...
8010571e:	e8 3d ea ff ff       	call   80104160 <kill>
...
80105743:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105746:	e8 25 e2 ff ff       	call   80103970 <myproc>
...
80105767:	78 27                	js     80105790 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80105769:	e8 02 e2 ff ff       	call   80103970 <myproc>
  if(growproc(n) < 0)
...
80105776:	e8 15 e3 ff ff       	call   80103a90 <growproc>
...
801057ad:	e8 6e f1 ff ff       	call   80104920 <argint>
...
801057c5:	e8 d6 ed ff ff       	call   801045a0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801057ca:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
801057cd:	8b 1d 60 3c 11 80    	mov    0x80113c60,%ebx
  while(ticks - ticks0 < n){
...
801057e8:	68 60 3c 11 80       	push   $0x80113c60
801057ed:	e8 4e e8 ff ff       	call   80104040 <sleep>
  while(ticks - ticks0 < n){
801057f2:	a1 60 3c 11 80       	mov    0x80113c60,%eax
...
801057ff:	73 2f                	jae    80105830 <sys_sleep+0x90>
    if(myproc()->killed){
80105801:	e8 6a e1 ff ff       	call   80103970 <myproc>
...
80105810:	68 80 3c 11 80       	push   $0x80113c80
80105815:	e8 26 ed ff ff       	call   80104540 <release>
  }
  release(&tickslock);
  return 0;
}
...
80105838:	e8 03 ed ff ff       	call   80104540 <release>
  return 0;
...
80105854:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105857:	68 80 3c 11 80       	push   $0x80113c80
8010585c:	e8 3f ed ff ff       	call   801045a0 <acquire>
  xticks = ticks;
80105861:	8b 1d 60 3c 11 80    	mov    0x80113c60,%ebx
  release(&tickslock);
80105867:	c7 04 24 80 3c 11 80 	movl   $0x80113c80,(%esp)
8010586e:	e8 cd ec ff ff       	call   80104540 <release>
  return xticks;
}
...
801058ee:	00 00 ef 
  initlock(&tickslock, "time");
801058f1:	68 9d 7c 10 80       	push   $0x80107c9d
...
80105974:	ff 24 85 44 7d 10 80 	jmp    *-0x7fef82bc(,%eax,4)
...
80105a55:	68 00 7d 10 80       	push   $0x80107d00
...
80105aa7:	68 a8 7c 10 80       	push   $0x80107ca8
...
80105bc3:	68 cc 7c 10 80       	push   $0x80107ccc
80105bc8:	e8 d3 aa ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105bcd:	83 c4 14             	add    $0x14,%esp
80105bd0:	68 a2 7c 10 80       	push   $0x80107ca2
...
80105c7c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105c7f:	bf c4 7d 10 80       	mov    $0x80107dc4,%edi
...
8010687f:	68 86 77 10 80       	push   $0x80107786
...
8010696d:	68 cc 7d 10 80       	push   $0x80107dcc
...
80106b9b:	68 11 7e 10 80       	push   $0x80107e11
...
80106c00:	68 2b 7e 10 80       	push   $0x80107e2b
...
80106c88:	68 cc 7e 10 80       	push   $0x80107ecc
...
80106d29:	68 49 7e 10 80       	push   $0x80107e49
...
80106d8b:	68 61 7e 10 80       	push   $0x80107e61
...
80106e6c:	68 7d 7e 10 80       	push   $0x80107e7d
...
80106f3c:	68 8e 7e 10 80       	push   $0x80107e8e
...
80106fb2:	68 98 7e 10 80       	push   $0x80107e98
...
80107087:	68 b2 7e 10 80       	push   $0x80107eb2
...
801071c6:	0f 0b                	ud2    
801071c8:	66 90                	xchg   %ax,%ax
801071ca:	66 90                	xchg   %ax,%ax
801071cc:	66 90                	xchg   %ax,%ax
...
801071d6:	c7 05 e0 44 11 80 80 	movl   $0x80,0x801144e0
801071dd:	00 00 00 
...
801071e0:	68 00 02 00 00       	push   $0x200
801071e5:	6a 00                	push   $0x0
801071e7:	68 f0 44 11 80       	push   $0x801144f0
	tempfs.supernode.free_inodes=MAX_INODES;
801071ec:	c7 05 e4 44 11 80 80 	movl   $0x80,0x801144e4
801071f3:	00 00 00 
	tempfs.supernode.total_blocks=MAX_BLOCKS;
801071f6:	c7 05 e8 44 11 80 80 	movl   $0x80,0x801144e8
801071fd:	00 00 00 
	tempfs.supernode.free_blocks=MAX_BLOCKS;
80107200:	c7 05 ec 44 11 80 80 	movl   $0x80,0x801144ec
80107207:	00 00 00 
	memset(tempfs.supernode.inode_bitmap,0,sizeof(tempfs.supernode.inode_bitmap));
8010720a:	e8 51 d4 ff ff       	call   80104660 <memset>
	memset(tempfs.supernode.block_bitmap,0,sizeof(tempfs.supernode.block_bitmap));
8010720f:	83 c4 0c             	add    $0xc,%esp
80107212:	68 00 02 00 00       	push   $0x200
80107217:	6a 00                	push   $0x0
80107219:	68 f0 46 11 80       	push   $0x801146f0
8010721e:	e8 3d d4 ff ff       	call   80104660 <memset>
	cprintf("Tempfs initialized");
80107223:	c7 04 24 ef 7e 10 80 	movl   $0x80107eef,(%esp)
8010722a:	e8 71 94 ff ff       	call   801006a0 <cprintf>
}
...
80107241:	a1 e4 44 11 80       	mov    0x801144e4,%eax
{
...
8010724c:	0f 84 86 00 00 00    	je     801072d8 <tempfscreate+0x98>
	{
		for(int i=0;i<MAX_INODES;i++)
80107252:	31 db                	xor    %ebx,%ebx
80107254:	eb 15                	jmp    8010726b <tempfscreate+0x2b>
80107256:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010725d:	8d 76 00             	lea    0x0(%esi),%esi
80107260:	83 c3 01             	add    $0x1,%ebx
80107263:	81 fb 80 00 00 00    	cmp    $0x80,%ebx
80107269:	74 6d                	je     801072d8 <tempfscreate+0x98>
		{
			if(tempfs.supernode.inode_bitmap[i]==0)
8010726b:	8b 14 9d f0 44 11 80 	mov    -0x7feebb10(,%ebx,4),%edx
80107272:	85 d2                	test   %edx,%edx
80107274:	75 ea                	jne    80107260 <tempfscreate+0x20>
	}
...
80107276:	69 f3 14 02 00 00    	imul   $0x214,%ebx,%esi
	tempfs.supernode.free_inodes--;
8010727c:	83 e8 01             	sub    $0x1,%eax
	new_inode->size=0;
	memset(new_inode->blocks,-1,sizeof(new_inode->blocks));
8010727f:	83 ec 04             	sub    $0x4,%esp
	tempfs.supernode.inode_bitmap[available_inode]=1;
80107282:	c7 04 9d f0 44 11 80 	movl   $0x1,-0x7feebb10(,%ebx,4)
80107289:	01 00 00 00 
	tempfs.supernode.free_inodes--;
8010728d:	a3 e4 44 11 80       	mov    %eax,0x801144e4
	memset(new_inode->blocks,-1,sizeof(new_inode->blocks));
80107292:	68 00 02 00 00       	push   $0x200
80107297:	8d 86 f8 48 11 80    	lea    -0x7feeb708(%esi),%eax
8010729d:	6a ff                	push   $0xffffffff
8010729f:	50                   	push   %eax
	new_inode->inode_num=available_inode;
801072a0:	89 9e f0 48 11 80    	mov    %ebx,-0x7feeb710(%esi)
	new_inode->size=0;
801072a6:	c7 86 f4 48 11 80 00 	movl   $0x0,-0x7feeb70c(%esi)
801072ad:	00 00 00 
	memmove(new_inode->filename,filename,sizeof(filename));
801072b0:	81 c6 f8 4a 11 80    	add    $0x80114af8,%esi
	memset(new_inode->blocks,-1,sizeof(new_inode->blocks));
801072b6:	e8 a5 d3 ff ff       	call   80104660 <memset>
	memmove(new_inode->filename,filename,sizeof(filename));
801072bb:	83 c4 0c             	add    $0xc,%esp
801072be:	6a 04                	push   $0x4
801072c0:	ff 75 08             	push   0x8(%ebp)
801072c3:	56                   	push   %esi
801072c4:	e8 37 d4 ff ff       	call   80104700 <memmove>
	return available_inode;
801072c9:	83 c4 10             	add    $0x10,%esp
}
801072cc:	8d 65 f8             	lea    -0x8(%ebp),%esp
801072cf:	89 d8                	mov    %ebx,%eax
801072d1:	5b                   	pop    %ebx
801072d2:	5e                   	pop    %esi
801072d3:	5d                   	pop    %ebp
801072d4:	c3                   	ret    
...
801072d8:	83 ec 0c             	sub    $0xc,%esp
		return -1;
801072db:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
		cprintf("No inodes available to create file");
801072e0:	68 04 7f 10 80       	push   $0x80107f04
801072e5:	e8 b6 93 ff ff       	call   801006a0 <cprintf>
		return -1;
801072ea:	83 c4 10             	add    $0x10,%esp
801072ed:	eb dd                	jmp    801072cc <tempfscreate+0x8c>
801072ef:	90                   	nop

801072f0 <tempfswrite>:
...
801072f6:	81 ec 2c 02 00 00    	sub    $0x22c,%esp
	int available_inode=-1;
	if(tempfs.supernode.free_inodes!=0)
801072fc:	8b 1d e4 44 11 80    	mov    0x801144e4,%ebx
80107302:	85 db                	test   %ebx,%ebx
80107304:	0f 84 e1 01 00 00    	je     801074eb <tempfswrite+0x1fb>
	{
		for(int i=0;i<MAX_INODES;i++)
8010730a:	31 ff                	xor    %edi,%edi
8010730c:	eb 11                	jmp    8010731f <tempfswrite+0x2f>
8010730e:	66 90                	xchg   %ax,%ax
80107310:	83 c7 01             	add    $0x1,%edi
80107313:	81 ff 80 00 00 00    	cmp    $0x80,%edi
80107319:	0f 84 cc 01 00 00    	je     801074eb <tempfswrite+0x1fb>
		{
			if(tempfs.supernode.inode_bitmap[i]==0)
8010731f:	8b 34 bd f0 44 11 80 	mov    -0x7feebb10(,%edi,4),%esi
80107326:	85 f6                	test   %esi,%esi
80107328:	75 e6                	jne    80107310 <tempfswrite+0x20>
	{
		cprintf("No inodes available to create file");
		return -1;
	}
...
8010732a:	8b 55 10             	mov    0x10(%ebp),%edx
8010732d:	8b 45 10             	mov    0x10(%ebp),%eax
80107330:	83 c0 3f             	add    $0x3f,%eax
80107333:	85 d2                	test   %edx,%edx
80107335:	0f 49 45 10          	cmovns 0x10(%ebp),%eax
        int blocks_available=0;
        int available_blocks[MAX_BLOCKS];
     	if(tempfs.supernode.free_blocks!=0)
80107339:	8b 15 ec 44 11 80    	mov    0x801144ec,%edx
        int blocks_available=0;
8010733f:	31 c9                	xor    %ecx,%ecx
	int blocks_required=size/BLOCK_SIZE;
80107341:	c1 f8 06             	sar    $0x6,%eax
80107344:	89 85 e4 fd ff ff    	mov    %eax,-0x21c(%ebp)
     	if(tempfs.supernode.free_blocks!=0)
8010734a:	85 d2                	test   %edx,%edx
8010734c:	0f 85 24 01 00 00    	jne    80107476 <tempfswrite+0x186>
...
80107352:	3b 8d e4 fd ff ff    	cmp    -0x21c(%ebp),%ecx
80107358:	0f 8c 50 01 00 00    	jl     801074ae <tempfswrite+0x1be>
    	{
	...
	tempfs.supernode.inode_bitmap[available_inode]=1;
	tempfs.supernode.free_inodes--;
8010735e:	8d 43 ff             	lea    -0x1(%ebx),%eax

	for(int i=0;i<blocks_required;i++)
80107361:	83 7d 10 3f          	cmpl   $0x3f,0x10(%ebp)
	tempfs.supernode.inode_bitmap[available_inode]=1;
80107365:	c7 04 bd f0 44 11 80 	movl   $0x1,-0x7feebb10(,%edi,4)
8010736c:	01 00 00 00 
	tempfs.supernode.free_inodes--;
80107370:	a3 e4 44 11 80       	mov    %eax,0x801144e4
	for(int i=0;i<blocks_required;i++)
80107375:	0f 8e f1 00 00 00    	jle    8010746c <tempfswrite+0x17c>
8010737b:	8b 9d e4 fd ff ff    	mov    -0x21c(%ebp),%ebx
        int blocks_available=0;
80107381:	31 c0                	xor    %eax,%eax
80107383:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80107387:	90                   	nop
        {
		tempfs.supernode.block_bitmap[available_blocks[i]]=1;
80107388:	8b 8c 85 e8 fd ff ff 	mov    -0x218(%ebp,%eax,4),%ecx
	for(int i=0;i<blocks_required;i++)
8010738f:	83 c0 01             	add    $0x1,%eax
		tempfs.supernode.block_bitmap[available_blocks[i]]=1;
80107392:	c7 04 8d f0 46 11 80 	movl   $0x1,-0x7feeb910(,%ecx,4)
80107399:	01 00 00 00 
	for(int i=0;i<blocks_required;i++)
8010739d:	39 c3                	cmp    %eax,%ebx
8010739f:	7f e7                	jg     80107388 <tempfswrite+0x98>
		tempfs.supernode.free_blocks--;
801073a1:	8b 85 e4 fd ff ff    	mov    -0x21c(%ebp),%eax
801073a7:	31 c9                	xor    %ecx,%ecx
		}
		...
		struct tempfs_inode *new_inode=&tempfs.inodes[available_inode];
		new_inode->inode_num=available_inode;
801073a9:	89 bd d8 fd ff ff    	mov    %edi,-0x228(%ebp)
801073af:	89 b5 d4 fd ff ff    	mov    %esi,-0x22c(%ebp)
		tempfs.supernode.free_blocks--;
801073b5:	83 e8 01             	sub    $0x1,%eax
801073b8:	f7 d8                	neg    %eax
801073ba:	83 7d 10 3f          	cmpl   $0x3f,0x10(%ebp)
801073be:	0f 4e c1             	cmovle %ecx,%eax
		new_inode->size=size;
		memmove(new_inode->filename,filename,sizeof(filename));
801073c1:	31 db                	xor    %ebx,%ebx
		tempfs.supernode.free_blocks--;
801073c3:	8d 44 02 ff          	lea    -0x1(%edx,%eax,1),%eax
801073c7:	a3 ec 44 11 80       	mov    %eax,0x801144ec
801073cc:	69 c7 14 02 00 00    	imul   $0x214,%edi,%eax
		memmove(new_inode->filename,filename,sizeof(filename));
801073d2:	8d 90 f8 4a 11 80    	lea    -0x7feeb508(%eax),%edx
801073d8:	89 85 dc fd ff ff    	mov    %eax,-0x224(%ebp)
		new_inode->inode_num=available_inode;
801073de:	05 e0 44 11 80       	add    $0x801144e0,%eax
		memmove(new_inode->filename,filename,sizeof(filename));
801073e3:	89 95 e0 fd ff ff    	mov    %edx,-0x220(%ebp)
		new_inode->inode_num=available_inode;
801073e9:	89 c7                	mov    %eax,%edi
801073eb:	eb 5f                	jmp    8010744c <tempfswrite+0x15c>
801073ed:	8d 76 00             	lea    0x0(%esi),%esi
		memmove(page,data,size);
801073f0:	83 ec 04             	sub    $0x4,%esp
801073f3:	ff 75 10             	push   0x10(%ebp)
801073f6:	ff 75 0c             	push   0xc(%ebp)
801073f9:	50                   	push   %eax
801073fa:	e8 01 d3 ff ff       	call   80104700 <memmove>
		new_inode->inode_num=available_inode;
801073ff:	8b 85 d8 fd ff ff    	mov    -0x228(%ebp),%eax
		memmove(new_inode->filename,filename,sizeof(filename));
80107405:	83 c4 0c             	add    $0xc,%esp
		new_inode->inode_num=available_inode;
80107408:	89 87 10 04 00 00    	mov    %eax,0x410(%edi)
		new_inode->size=size;
8010740e:	8b 45 10             	mov    0x10(%ebp),%eax
80107411:	89 87 14 04 00 00    	mov    %eax,0x414(%edi)
		memmove(new_inode->filename,filename,sizeof(filename));
80107417:	6a 04                	push   $0x4
80107419:	ff 75 08             	push   0x8(%ebp)
8010741c:	ff b5 e0 fd ff ff    	push   -0x220(%ebp)
80107422:	e8 d9 d2 ff ff       	call   80104700 <memmove>
		new_inode->blocks[i]=V2P(page);
80107427:	8b 85 dc fd ff ff    	mov    -0x224(%ebp),%eax
8010742d:	8d 96 00 00 00 80    	lea    -0x80000000(%esi),%edx
	for(int i=0;i<blocks_required;i++)
80107433:	83 c4 10             	add    $0x10,%esp
		new_inode->blocks[i]=V2P(page);
80107436:	89 94 98 f8 48 11 80 	mov    %edx,-0x7feeb708(%eax,%ebx,4)
	for(int i=0;i<blocks_required;i++)
8010743d:	83 c3 01             	add    $0x1,%ebx
80107440:	39 9d e4 fd ff ff    	cmp    %ebx,-0x21c(%ebp)
80107446:	0f 8e 8f 00 00 00    	jle    801074db <tempfswrite+0x1eb>
		char * page = kalloc();
8010744c:	e8 2f b2 ff ff       	call   80102680 <kalloc>
80107451:	89 c6                	mov    %eax,%esi
		if(page==0)
80107453:	85 c0                	test   %eax,%eax
80107455:	75 99                	jne    801073f0 <tempfswrite+0x100>
			cprintf("Memory is full. Couldn't write to file");
80107457:	83 ec 0c             	sub    $0xc,%esp
			return -1;
8010745a:	be ff ff ff ff       	mov    $0xffffffff,%esi
			cprintf("Memory is full. Couldn't write to file");
8010745f:	68 50 7f 10 80       	push   $0x80107f50
80107464:	e8 37 92 ff ff       	call   801006a0 <cprintf>
			return -1;
...
80107476:	31 c0                	xor    %eax,%eax
        int blocks_available=0;
80107478:	31 c9                	xor    %ecx,%ecx
8010747a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
			if(tempfs.supernode.block_bitmap[i]==0)
80107480:	83 3c 85 f0 46 11 80 	cmpl   $0x0,-0x7feeb910(,%eax,4)
80107487:	00 
80107488:	75 0e                	jne    80107498 <tempfswrite+0x1a8>
				available_blocks[blocks_available]=1;
8010748a:	c7 84 8d e8 fd ff ff 	movl   $0x1,-0x218(%ebp,%ecx,4)
80107491:	01 00 00 00 
				blocks_available=blocks_available+1;
80107495:	83 c1 01             	add    $0x1,%ecx
		for(int i=0;i<MAX_BLOCKS;i++)
80107498:	83 c0 01             	add    $0x1,%eax
8010749b:	3d 80 00 00 00       	cmp    $0x80,%eax
801074a0:	75 de                	jne    80107480 <tempfswrite+0x190>
	if(blocks_available<blocks_required) 
801074a2:	3b 8d e4 fd ff ff    	cmp    -0x21c(%ebp),%ecx
801074a8:	0f 8d b0 fe ff ff    	jge    8010735e <tempfswrite+0x6e>
		cprintf("No blocks available to write to file");
801074ae:	83 ec 0c             	sub    $0xc,%esp
801074b1:	68 28 7f 10 80       	push   $0x80107f28
801074b6:	e8 e5 91 ff ff       	call   801006a0 <cprintf>
	tempfs.supernode.free_inodes--;
801074bb:	83 2d e4 44 11 80 01 	subl   $0x1,0x801144e4
801074c2:	8b 15 ec 44 11 80    	mov    0x801144ec,%edx
801074c8:	83 c4 10             	add    $0x10,%esp
	tempfs.supernode.inode_bitmap[available_inode]=1;
801074cb:	c7 04 bd f0 44 11 80 	movl   $0x1,-0x7feebb10(,%edi,4)
801074d2:	01 00 00 00 
	for(int i=0;i<blocks_required;i++)
801074d6:	e9 a0 fe ff ff       	jmp    8010737b <tempfswrite+0x8b>
801074db:	8b b5 d4 fd ff ff    	mov    -0x22c(%ebp),%esi
}
801074e1:	8d 65 f4             	lea    -0xc(%ebp),%esp
801074e4:	5b                   	pop    %ebx
...
801074eb:	83 ec 0c             	sub    $0xc,%esp
		return -1;
801074ee:	be ff ff ff ff       	mov    $0xffffffff,%esi
		cprintf("No inodes available to create file");
801074f3:	68 04 7f 10 80       	push   $0x80107f04
801074f8:	e8 a3 91 ff ff       	call   801006a0 <cprintf>
		return -1;
801074fd:	83 c4 10             	add    $0x10,%esp
80107500:	e9 67 ff ff ff       	jmp    8010746c <tempfswrite+0x17c>
