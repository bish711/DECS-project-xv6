...
main(void)
{
  ...
  // *******NEW********
  mkdir("/proc"); // Create /proc directory
  3f:	c7 04 24 e0 07 00 00 	movl   $0x7e0,(%esp)
  46:	e8 70 03 00 00       	call   3bb <mkdir>
  mount("/proc"); // Mount procfs
  4b:	c7 04 24 e0 07 00 00 	movl   $0x7e0,(%esp)
  52:	e8 9c 03 00 00       	call   3f3 <mount>
  ...
  b4:	50                   	push   %eax
  b5:	50                   	push   %eax
  b6:	68 3c 0b 00 00       	push   $0xb3c
  bb:	68 0c 08 00 00       	push   $0x80c
  c0:	e8 c6 02 00 00       	call   38b <exec>
      printf(1, "init: exec sh failed\n");
  c5:	5a                   	pop    %edx
  c6:	59                   	pop    %ecx
  c7:	68 0f 08 00 00       	push   $0x80f
  cc:	6a 01                	push   $0x1
 ...
 4b9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 529:	ff 24 85 38 08 00 00 	jmp    *0x838(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 637:	90                   	nop
          s = "(null)";
 638:	ba 2e 08 00 00       	mov    $0x82e,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 651:	a1 44 0b 00 00       	mov    0xb44,%eax
{
 ...
 691:	5b                   	pop    %ebx
  freep = p;
 692:	89 15 44 0b 00 00    	mov    %edx,0xb44
}
 698:	5e                   	pop    %esi
 699:	5f                   	pop    %edi
 69a:	5d                   	pop    %ebp
 ...
 6c9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6cc:	89 15 44 0b 00 00    	mov    %edx,0xb44
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ec:	8b 3d 44 0b 00 00    	mov    0xb44,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 72f:	73 4f                	jae    780 <malloc+0xa0>
    ...
    if(p == freep)
 731:	8b 3d 44 0b 00 00    	mov    0xb44,%edi
 ...
 75a:	e8 f1 fe ff ff       	call   650 <free>
  return freep;
 75f:	8b 15 44 0b 00 00    	mov    0xb44,%edx
 ...
 78c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 78f:	89 15 44 0b 00 00    	mov    %edx,0xb44
}
 ...
 79f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7a0:	c7 05 44 0b 00 00 48 	movl   $0xb48,0xb44
 7a7:	0b 00 00 
    base.s.size = 0;
 7aa:	bf 48 0b 00 00       	mov    $0xb48,%edi
    base.s.ptr = freep = prevp = &base;
 7af:	c7 05 48 0b 00 00 48 	movl   $0xb48,0xb48
 7b6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7b9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7bb:	c7 05 4c 0b 00 00 00 	movl   $0x0,0xb4c
 7c2:	00 00 00 
    if(p->s.size >= nunits){
